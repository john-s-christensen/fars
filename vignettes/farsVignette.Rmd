...
1. You can summarize car accident fatality counts by year using the `fars_summarize_years()` function
2. You can visualize car accident fatalities within a state & year using the `fars_map_state()` function

## Summarize accident fatalities by year using `fars_summarize_years()`
